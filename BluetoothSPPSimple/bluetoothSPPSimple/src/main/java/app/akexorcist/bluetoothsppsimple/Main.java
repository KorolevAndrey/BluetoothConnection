...
public class Main extends Activity {
	...
	public void setup() {
        ...
        Button btnVal1 = (Button)findViewById(R.id.btnVal1);
        btnVal1.setOnClickListener(new OnClickListener(){
        	public void onClick(View v){
        		bt.send("1", true);
        	}
        });

        Button  btnVal2 = (Button)findViewById(R.id.btnVal2);
        btnVal2.setOnClickListener(new OnClickListener(){
            public void onClick(View v){
                bt.send("2", true);
            }
        });
